...
public abstract class AbstractBDB {
	...
	public static final String LOGTAG = AbstractBDB.class.getSimpleName();
	...
	protected void stopEnvironment() throws DatabaseException {
		...
		if (Log.isLoggable(LOGTAG, Log.INFO)) {
			Log.i(LOGTAG, "Closed BDB located in '" + getStorageFolderPath() + "'");
		}
	}
	...
	protected void startEnvironment() throws DatabaseException {
		...
		if (Log.isLoggable(LOGTAG, Log.INFO)) {
			Log.i(LOGTAG, "Initialised BDB located in '" + getStorageFolderPath() + "'"
